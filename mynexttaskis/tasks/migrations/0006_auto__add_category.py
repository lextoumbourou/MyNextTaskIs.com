...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tasks_task_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm['tasks.task'], null=False)),
            ('category', models.ForeignKey(orm['tasks.category'], null=False))
        ))
        db.create_unique('tasks_task_categories', ['task_id', 'category_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tasks_task_categories')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['tasks.Category']", 'symmetrical': 'False'}),
