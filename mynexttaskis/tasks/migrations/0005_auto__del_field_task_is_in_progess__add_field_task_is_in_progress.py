...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.is_in_progess'
        db.delete_column('tasks_task', 'is_in_progess')

        # Adding field 'Task.is_in_progress'
        db.add_column('tasks_task', 'is_in_progress',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.is_in_progess'
        db.add_column('tasks_task', 'is_in_progess',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Task.is_in_progress'
        db.delete_column('tasks_task', 'is_in_progress')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'is_in_progress': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
